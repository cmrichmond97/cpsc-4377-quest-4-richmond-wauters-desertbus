...
bool Texture::load(SDL_Renderer* renderer, std::string path, COLOR_KEY key)
{
	...
	{
		//Color key image
		SDL_SetColorKey(surface, SDL_TRUE, SDL_MapRGBA(surface->format, key.r, key.g, key.b, key.a));
...
void Texture::render(SDL_Renderer* renderer, int x, int y, SPRITE_CLIP* spriteClip)
{
